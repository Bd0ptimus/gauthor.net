        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" name="login" action="{{ route('auth.forgot.index') }}" method="post" enctype="multipart/form-data"> @csrf
                        <span class="login100-form-title" style="padding-bottom:10px;">
                            Quên mật khẩu hỏ?
                        </span>

                        <span >
                            <p class="login100-form-comment text-center mb-5">
                                Nhập email bị quên mật khẩu vào đây nha
