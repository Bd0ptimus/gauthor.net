...
<body onload="mainPageOnload()">
    ...
    <div id="page">
        ...
        <header id="fh5co-header" class="fh5co-cover" role="banner"
            style="background-image:url({{ asset('front/images/img_bg_2.jpg') }}" data-stellar-background-ratio="0.5">
                        ...
                        <ul class="timeline animate-box">
                            <li class="animate-box">
                                <div class="timeline-badge"
                                    style="background-image:url({{ asset('front/images/couple-1.jpg') }}"></div>
        ...
        <div id="fh5co-gallery" style="background-image:url({{ asset('front/images/img_bg_5.jpg') }}">
                        ...
                        <div class="display-tc">
                            <div class="col-md-3 col-sm-6 animate-box">
                                <div class="feature-center">
                                    ...
                                    <span id="day-counter" class="counter js-counter" data-from="0"
                                        data-speed="2500" data-refresh-interval="50">0</span>
                            ...
                            <div class="col-md-3 col-sm-6 animate-box">
                                <div class="feature-center">
                                    ...
                                    <span id="hour-counter" class="counter js-counter" data-from="0"
        ...
        <div id="fh5co-started" class="fh5co-bg"
            style="background-image:url({{ asset('front/images/img_bg_4.jpg') }}">
            <div class="overlay"></div>
            <div class="container">
