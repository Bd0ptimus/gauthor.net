...
<div id="loading-icon" class="row"
    style="background-color:white;z-index:100; width:100%; height:100%; position: absolute; margin:auto; top: 50%; transform: translateY(-50%);">
    <div class="waterfall">
        <div></div>
        <div></div>
        <div></div>
